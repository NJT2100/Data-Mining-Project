...
def main():
    ...
    text_clf = Pipeline([
        ...
        ('clf', RandomForestClassifier(max_depth=60, min_samples_leaf=10, random_state=0, warm_start=True, verbose=1))
    ])
    ...
    print("Forest Model completed in %d seconds" % (end - start))
